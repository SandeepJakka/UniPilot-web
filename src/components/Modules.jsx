        ...
        <section id="features" className="modules-section">
            <div className="container">
                <div className="modules-header animate-fade-up">
                    ...
                    <p className="section-desc">137+ enterprise features precision-engineered for India's most ambitious universities.</p>
                </div>
                ...
                <div className="module-grid">
                    <div className="module-content order-2">
                        ...
                        <p className="module-text">From exam scheduling to digital script viewing - handle the entire examination lifecycle in one place. Reduce result processing time from weeks to days.</p>
                                ...
                                <div className="dash-grid">
                                    {[1, 2, 3, 4].map(i => (
                                        <div key={i} className="dash-item">
                                            <div className="dash-item-bar" style={{ height: `${20 + (i * 15)}%`, opacity: 0.5 + (i * 0.1) }}></div>
                ...
                <div className="module-grid">
                    ...
                    <div className="module-content">
                        ...
                        <p className="module-text">Automated fee collection, payment gateway integration, and real-time financial reporting. Track every rupee with precision.</p>
                        <div className="finance-list">
                            <div className="finance-item highlight">
                                <span className="material-symbols-outlined text-primary text-3xl">account_balance</span>
                                <div>
                                    <div className="item-title">Unified Fee Ledgers</div>
                                    <div className="item-desc">Real-time reconciliation of all payments.</div>
                                </div>
                            </div>
                            <div className="finance-item">
                                ...
                                <div>
                                    ...
                                    <div className="item-desc">Semester-wise scholarship configurations.</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="module-grid">
                    <div className="module-content order-2">
                        ...
                        <p className="module-text">Manage hostel allocations, transport logistic, and mess services. Complete campus digitalization.</p>
                        <ul className="check-list">
                            <li><span className="check-icon material-symbols-outlined">check</span> Hostel room allocation grid</li>
                            <li><span className="check-icon material-symbols-outlined">check</span> Transport route map</li>
                            <li><span className="check-icon material-symbols-outlined">check</span> Fragmented Fee Management</li>
                        </ul>
                    </div>
                    <div className="module-visual order-1">
                        <div className="visual-card hover-lift">
                ...
                <div className="module-grid">
                    ...
                    <div className="module-content">
                        ...
                        <p className="module-text">Bridge the gap between students and careers. Maximize placement rates with automated drive management and eligibility filters.</p>
                    </div>
                </div>
            </div>
        </section>
