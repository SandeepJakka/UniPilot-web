            ...
            <div className="container">
                <div className="mobile-grid">
                    ...
                    <div className="mobile-visual">
                        ...
                        <div className="phone-frame">
                            ...
                            <div className="phone-screen">
                                <div className="screen-header">
                                    ...
                                    <span className="material-symbols-outlined text-white-70">notifications_active</span>
                                </div>
                                ...
                                <div className="screen-content">
                                    ...
                                    <div className="app-grid">
                                        <div className="app-icon bg-primary">
                                            <span className="material-symbols-outlined text-3xl mb-3">event_available</span>
                                            <div className="icon-label">Attendance</div>
                                        </div>
                                        <div className="app-icon bg-slate-800">
                                            <span className="material-symbols-outlined text-3xl mb-3">account_balance_wallet</span>
                        ...
                        <div className="floating-notif notif-2 floating-delayed">
                            <div className="notif-icon bg-primary-10 text-primary">
                                <span className="material-symbols-outlined text-3xl">mark_as_unread</span>
                            </div>
                            <div>
                    ...
                    <div className="mobile-content">
                        ...
                        <h2 className="mobile-title">Education, <br /><span className="text-primary">In Their Pocket.</span></h2>
                        <p className="mobile-desc">
                            UniPilot's mobile ecosystem bridges the gap between the university and the student. Instant alerts, digital IDs, and transparent fee portals reduce administrative inquiries by 85%.
                        </p>
                        ...
                        <div className="features-list">
                            <div className="feature-item">
                                ...
                                <div>
                                    ...
                                    <p className="feature-sub">Zero-latency notifications for results, fee deadlines, and campus alerts.</p>
                                </div>
                            </div>
                            ...
                            <div className="feature-item">
                                ...
                                <div>
                                    ...
                                    <p className="feature-sub">Secure digital credentials for library access, hostel entry, and exam halls.</p>
                                </div>
                            </div>
                        </div>
